...
class HomeActivity : DebugActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this, "Prefs: ${nome_usuario}", Toast.LENGTH_LONG).show()
        ...
        welcome_home.setText("Olá, $usuario")
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when(item.itemId){
            ...
            R.id.nav_profissional -> {
                var intent_profissional = Intent(this, ProfissionalActivity::class.java)
                startActivity(intent_profissional)
